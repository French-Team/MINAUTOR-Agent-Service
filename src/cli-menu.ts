...
export function showMenu(_engine: Engine): void {
  ...
  console.log(`${BOLD}${CYAN}║  ${CYAN}11${RESET}. Profil tiny     (LFM2.5-1.2B, ≤1.5B)`)
  console.log(`${BOLD}${CYAN}║  ${CYAN}12${RESET}. Profil small    (Llama3.2-3B, 1.5–4B)`)
  console.log(`${BOLD}${CYAN}║  ${CYAN}13${RESET}. Profil medium   (Mistral-7B, 4–15B)`)
  console.log(`${BOLD}${CYAN}║  ${CYAN}14${RESET}. Profil large    (GPT-4, 15B–70B/cloud)`)
  console.log(`${BOLD}${CYAN}║  ${CYAN}15${RESET}. Profil huge     (Gemini 2.5, 1M+ tokens)`)
  console.log(`${BOLD}${CYAN}║  ${CYAN}23${RESET}. Llama3 8B        (règle #20 spécifique)`)
  console.log(`${BOLD}${CYAN}║${RESET}`)
  console.log(`${BOLD}${CYAN}║  ${GRAY}── Routeurs génériques ──${RESET}`)
  console.log(`${BOLD}${CYAN}║  ${CYAN}16${RESET}. Routeur Kilo Gateway     (kilo-auto)`)
  console.log(`${BOLD}${CYAN}║  ${CYAN}17${RESET}. Routeur OpenRouter       (openrouter/)`)
  console.log(`${BOLD}${CYAN}║  ${CYAN}18${RESET}. Routeur :free            (modèles gratuits)`)
  console.log(`${BOLD}${CYAN}║  ${CYAN}19${RESET}. Routeur Opencode Zen     (opencode-zen/)`)
  console.log(`${BOLD}${CYAN}║  ${CYAN}20${RESET}. Routeur LM Studio        (local-model)`)
  console.log(`${BOLD}${CYAN}║  ${CYAN}21${RESET}. Routeur Custom            (custom/)`)
  console.log(`${BOLD}${CYAN}║  ${CYAN}22${RESET}. Résumé tous les routeurs  (tableau complet)`)
  console.log(`${BOLD}${CYAN}║${RESET}`)
