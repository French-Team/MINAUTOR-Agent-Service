...
export function showMenu(_engine: Engine): void {
  ...
  console.log(`${BOLD}${CYAN}║  ${CYAN}6${RESET}.  Démarrer une session`)
  console.log(`${BOLD}${CYAN}║  ${CYAN}7${RESET}.  Gérer les sessions`)
  console.log(`${BOLD}${CYAN}║${RESET}`)
  console.log(`${BOLD}${CYAN}║  ${GRAY}── Monitoring ──${RESET}`)
  console.log(`${BOLD}${CYAN}║  ${CYAN}8${RESET}.  Status & notifications`)
  console.log(`${BOLD}${CYAN}║${RESET}`)
  console.log(`${BOLD}${CYAN}║  ${GRAY}── Aide ──${RESET}`)
  console.log(`${BOLD}${CYAN}║  ${CYAN}9${RESET}.  Commandes & aide`)
...
export function showHelp(engine: Engine): void {
  ...
  console.log(`  ${GREEN}/skills load <nom>${RESET}    Charger une skill dans la session\n`)
